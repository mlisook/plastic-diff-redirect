...
(function() {
    ...
    function bcapData(ua) {
      ...
      var mobileSafari = {
        ...
        push: versionAtLeast([9, 2], parseVersion(ua.getOS().version)),
        serviceworker: since(ua, 11, 3),
        modules: versionAtLeast([11, 3], parseVersion(ua.getOS().version))
      };
    ...
    function browserCapabilities(userAgent) {
      ...
      var predicates =
        bcapData(ua).browserPredicates[browserName || ""] || {};
